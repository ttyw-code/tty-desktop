...
import * as descriptors  from '@/platform/instantiation/common/instantiation/descriptors.js';
import { ServiceCollection } from '@/platform/instantiation/common/instantiation/serviceCollection.js';

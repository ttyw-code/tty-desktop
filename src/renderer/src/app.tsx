    ...
    return (
        <div className="drag-region flex h-full w-full flex-col overflow-hidden">
            <div className={`flex-1 overflow-hidden ${activeApp ? "p-0" : "p-6"}`}>
                {activeApp && <div className="sticky top-0 left-5 z-99999 flex items-center justify-between">
                    <Button
                        className="no-drag text-lg"
                        startContent={<Undo2 />}
                ...
                {activeApp === "basicPage" && (
                    <div className="mt-2 flex w-full h-full flex-col space-y-4 overflow-hidden">
                        <div className="min-h-0 rounded-2xl border border-default-200">
                            <BasePage
                                title="基础页面"
